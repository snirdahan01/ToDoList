...
namespace ToDoList.Controllers
{
    public class ToDoesController : Controller
    {
        ...
        {
            //Return the tasks table for the current user.
            ...
            //Caculate the precentage complete.
            int completeCount = 0;
            ...
            ViewBag.Precent = Math.Round(100 * ((float)completeCount / (float)myToDoes.Count()));
        ...
        {
            //Returning same table but with a partial view.
